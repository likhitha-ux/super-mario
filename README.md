...
A browser‑based Super Mario Bros clone built with TypeScript, HTML5 Canvas, and modern web technologies. This project demonstrates not only game development but also DevOps practices like containerization, CI/CD, code quality checks, and monitoring.
